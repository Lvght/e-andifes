...
BEGIN
	...
	ELSE -- Caso a turma não estiver cadastrada, insere ela
		INSERT INTO turma_ofertada_idioma (dia_semana, horario_inicio, idioma, dia_horario_aulas, titulo, data_inicio, 
										   data_fim, tipo_oferta, horario_termino, numero_inscritos, id_curso, 
										   cpf_professor_isf)
		VALUES (p_dia_semana, p_horario_inicio, p_idioma, p_dia_horario_aulas, p_titulo, p_data_inicio, p_data_fim, 
				p_tipo_oferta, p_horario_termino, p_numero_inscritos, p_id_curso, p_cpf_professor_isf);
	END IF;
END;
$$ LANGUAGE plpgsql;